...
const particle = require('url!./snowflake1.png'); // eslint-disable-line import/no-extraneous-dependencies
const particle2 = require('url!./snowflake.png'); // eslint-disable-line import/no-extraneous-dependencies

let particleTexture, particleTexture2;
loader.load(particle, texture => { particleTexture = texture; });
loader.load(particle2, texture => { particleTexture2 = texture; });
